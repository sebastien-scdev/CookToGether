        ...
        <div class="row justify-content-center mb-4">
            <div class="col-lg-12 news-display" style="display: contents;">
                ...
                <div class="col-lg-12 mt-3 mb-3">
                    <div class="release_info_news"
                        style="font-size:2em; text-align:left;display: flex; flex-direction: row;">
                        <?php 
                ...
                <div id="hero">
                    ...
                    <div class="content">
                        ...
                        <a
                            href="<?php echo esc_url( $hero['link']['url'] ); ?>"><?php echo esc_html( $hero['link']['title'] ); ?></a>
                    </div>
                </div>
                <style type="text/css">
                    #hero {
